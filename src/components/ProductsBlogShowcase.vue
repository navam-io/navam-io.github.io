...
const loadFeaturedPosts = async () => {
  try {
    ...
    // Filter posts by Navam Memo tag
      ...
      featuredPosts.value = [
        {
          ...
          title: 'Introducing Navam Memo: Transform Your Browsing with AI',
        ...
        },
        {
          ...
          title: 'Privacy-First Design: How Navam Memo Protects Your Data',
        ...
        },
        {
          ...
          title: 'Multi-AI Provider Support in Navam Memo',
          excerpt: 'Explore how Navam Memo integrates with multiple AI providers to give you choice and flexibility in your knowledge workflows.',
          featuredImage: '/images/blog/select-content-to-capture.png',
          author: 'Navam Team',
        ...
        },
        {
          ...
          title: 'YouTube Integration in Navam Memo',
        ...
        },
        {
          ...
          title: 'Local AI with Ollama in Navam Memo',
