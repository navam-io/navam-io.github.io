...
relatedPosts: ["moments-knowledge-graph-network-visualization", "moments-factor-analytics-sunburst-visualization", "moments-dashboard-three-tier-analytics"]
...
## See Correlation Analytics in Production

See correlation matrix analytics in production. The Moments platform automatically discovers hidden relationships across business events:

<BreakoutSection client:load>
  <ProductCard client:load product="moments" imagePosition="left" />
</BreakoutSection>
