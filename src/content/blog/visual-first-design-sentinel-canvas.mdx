...
date: "2025-11-16"
author: "Navam Team"
excerpt: "Shipping Sentinel v0.3.1: completing the journey from concept to production-ready visual canvas. Learn how we migrated from Svelte to React, simplified UX from drag-and-drop to click-to-add, and built comprehensive test infrastructure—all in 48 hours."
featuredImage: "/refer/images/sentinel/canvas-palette-react.png"
...
![Sentinel Visual Canvas](/refer/images/sentinel/canvas-palette-react.png)
