...
date: "2025-11-16"
author: "Navam Team"
excerpt: "We just shipped Sentinel v0.3.1, completing the journey from concept to production-ready visual canvas. Learn how we migrated from Svelte to React, simplified our UX, and built comprehensive test infrastructure—all in just 2 days."
featuredImage: "/images/sentinel/canvas-palette-react.png"
...
![Sentinel Visual Canvas](/images/sentinel/canvas-palette-react.png)
